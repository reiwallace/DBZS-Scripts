 ...
 * @param {int} duration - Duration of the timer (I add +1 for timer delay just put in timer duration)
 ...
 */
function particleDirectionChange(world, particlePath, duration, x, y, z, mx, my, mz) {
    var particle = API.createParticle(particlePath);
    particle.setPosition(x, y, z);
    particle.setMaxAge(duration + 1);
 ...
 * @param {int} duration - How long particle was in motion for
...
function getNewPos(oldPos, oldMotion, duration) {
    ...
    return [oldPos[0] + oldMotion[0] * duration, oldPos[1] + oldMotion[1] * duration, oldPos[2] + oldMotion[2] * duration];
}