 ...
 * @returns 
 */
function progressBar(maxValue, initialValue, overlayId) 
{
...
progressBar.prototype.setBar = function(value)
{
    ...
    // Add bar text
    var text = this.PROGRESS_WTIH_TEXT ? this.TEXT + value : this.TEXT;
...
{
    if(player) player.closeOverlay(this.overlayId); 
}